    ...
    void Update()
    {
        ...
        if ( !(ac == void_chat.action))
        {
            switch (void_chat.action)
            {
                ...
                case "Move_Left":
                    gameObject.transform.rotation = Quaternion.Euler(0f, -90f, 180f);
        ...
        switch (ac)
        {
            ...
            case "Move_Left":
                ...
                gameObject.transform.localPosition = Vector3.MoveTowards(gameObject.transform.localPosition, new Vector3(100f, -120f, 0f), step);
            ...
            case "Reset":
                if (gameObject.transform.localPosition.x > 0f)
                {
                    gameObject.transform.localPosition = Vector3.MoveTowards(gameObject.transform.localPosition, new Vector3(0f, -120f, 0f), step);
                }
